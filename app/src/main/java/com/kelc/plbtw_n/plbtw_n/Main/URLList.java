...
public class URLList {
    ...
    private String Url_InsertNews = Url_Utama + "index.php/api/news/news";
    ...
    public String getUrl_News() { return Url_News; }
    ...
    public String getUrl_InsertNews() { return Url_InsertNews; }
}
